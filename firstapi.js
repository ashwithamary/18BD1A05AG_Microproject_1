...
app.put('/updateventilator',(req,res)=>{
    var ventilid={hvno:req.body.hvno};
    console.log(ventilid);
    var newventid={ $set:{status:req.body.status}};
    db.collection("ventilators").updateOne(ventilid,newventid,function(err,result){
